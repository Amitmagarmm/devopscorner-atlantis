# ==========================================================================
#  098765432101 - EKS: _eks_var.tf (Spesific Environment)
# --------------------------------------------------------------------------
#  Description
# --------------------------------------------------------------------------
...
variable "dns_url" {
  type = map(string)
  default = {
    lab     = "atlantis-dci.xapiens.id"
    staging = "atlantis-dci.xapiens.id"
    nonprod = "atlantis-dci.xapiens.id"
    prod    = "atlantis-dci.xapiens.id"
  }
}
