# Terraform EKS for 112233445566
...
| <a name="input_dns_url"></a> [dns\_url](#input\_dns\_url) | n/a | `map(string)` | <pre>{<br/>  "lab": "atlantis-dci.xapiens.id",<br/>  "nonprod": "atlantis-dci.xapiens.id",<br/>  "prod": "atlantis-dci.xapiens.id",<br/>  "staging": "atlantis-dci.xapiens.id"<br/>}</pre> | no |
| <a name="input_dns_zone"></a> [dns\_zone](#input\_dns\_zone) | -------------------------------------------------------------------------- DNS (Public) -------------------------------------------------------------------------- | `map(string)` | <pre>{<br/>  "dev": "Z04003073DCF9BY5JJQFT",<br/>  "lab": "Z04003073DCF9BY5JJQFT",<br/>  "nonprod": "Z04003073DCF9BY5JJQFT",<br/>  "prod": "Z04003073DCF9BY5JJQFT",<br/>  "staging": "Z04003073DCF9BY5JJQFT",<br/>  "uat": "Z04003073DCF9BY5JJQFT"<br/>}</pre> | no |
| <a name="input_eks_cluster_name"></a> [eks\_cluster\_name](#input\_eks\_cluster\_name) | default cluster name | `string` | `"dci-eks"` | no |
...
| <a name="input_tfstate_bucket"></a> [tfstate\_bucket](#input\_tfstate\_bucket) | Name of bucket to store tfstate | `string` | `"tf-state-112233445566-ap-southeast-3"` | no |
| <a name="input_tfstate_dynamodb_table"></a> [tfstate\_dynamodb\_table](#input\_tfstate\_dynamodb\_table) | Name of dynamodb table to store tfstate | `string` | `"ddb-tf-state-112233445566-ap-southeast-3"` | no |
